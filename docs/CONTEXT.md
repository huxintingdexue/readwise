...
- 最近变更：顶部文案统一回滚为固定“今日硅谷 / 全球一手信息 触手可及”（今日/人物/我的一致）✅
- 最近变更：人物列表卡片支持显示多个标签（` / ` 连接）✅
- 最近变更：新增“人物”Tab（底部三导航：今日/人物/我的），并接入人物列表页与人物详情页 ✅
- 最近变更：人物支持“全部/关注中”筛选；关注状态先存 `localStorage`，后续再迁移数据库 ✅
- 最近变更：人物详情页复用现有文章卡片样式展示该人物文章，按发布时间倒序 ✅
