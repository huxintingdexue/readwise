...
- 当前已有真实数据：❌
- 下一步任务：PRD 第十一节第 3 步：抓取脚本 + GitHub Actions
...
| 文件 | 职责 | 状态 |
|------|------|------|
| scripts/fetch-articles.js | 抓取RSS、爬全文、生成content_plain、翻译前2000字、写入数据库 | ⬜ 待开发 |
| .github/workflows/fetch.yml | cron UTC 14:00，支持 INITIAL_FETCH | ⬜ 待开发 |
